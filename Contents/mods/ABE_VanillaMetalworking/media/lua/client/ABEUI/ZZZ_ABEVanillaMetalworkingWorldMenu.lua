	...
	ContextMenu_Metalworking = {
		...
		ContextMenu_Metal_Containers = {
			...
			ContextMenu_Metal_Crate = {
				...
				resultClassConstructor = "images.west, images.north",
				ingredients = {
					["Base.MetalPipe"] = 2,
			...
			ContextMenu_Metal_Shelves = {
				...
				resultClassConstructor = "ISSimpleFurniture:new(md.name, images.west, images.north)",
				ingredients = {
					["Base.MetalPipe"] = 2,
			...
			ContextMenu_Metal_Counter = {
				...
				resultClass = "ISWoodenContainer",
				resultClassConstructor = "ISWoodenContainer:new(md.name, images.west, images.north)",
				ingredients = {
					["Base.MetalPipe"] = 2,
		...
		ContextMenu_Metal_Fences = {
			...
			ContextMenu_Metal_Fence = {
				...
				resultClassObject = function() return ISWoodenWall end,
				resultClassRender = function(...) return ISWoodenWall.render(...) end,
				resultClassConstructor = function(...) return ISWoodenWall:new(...) end,
				ingredients = {
					-- ["Base.MetalPipe"] = 1,
					-- ["Base.SmallSheetMetal"] = 2
				},
				...
				requirements = { any = { MetalWelding = { level = 0, time = 1 } } },
			...
			ContextMenu_Metal_Pole_Fence = {
				...
				resultClass = "ISWoodenWall",
				resultClassConstructor = "ISWoodenWall:new(images.west, images.north, images.corner)",
				ingredients = {
					["Base.MetalPipe"] = 3
				},
				images = {
		...
		ContextMenu_Metal_Doors = {
			...
			ContextMenu_Metal_Fence_Gate = {
				...
				resultClassConstructor = "ISWoodenDoor:new(images.west, images.north, images.open, images.openNorth)",
				ingredients = {
					["Base.MetalPipe"] = 3,
					["Base.Hinge"] = 2
				},
			...
			ContextMenu_Metal_Big_Metal_Double_Pole_Door = {
				...
				resultClassObject = function() return ISDoubleDoor end,
				resultClassRender = function(...) return ISDoubleDoor.render(...) end,
				resultClassConstructor = function(...) return ISDoubleDoor:new(...) end,
				ingredients = {
					--["Base.MetalPipe"] = 10
				},
				images = {
			...
			ContextMenu_Metal_Big_Metal_Double_Metal_Door = {
				...
				resultClassRender = function(...) return ISDoubleDoor.render(...) end,
				resultClassConstructor = function(...) return ISDoubleDoor:new(...) end,
				resultClassConstructorProps = {
					[0] = "sprite",
					[1] = "spriteIndex"
				},
				functionOverride = {
					getSquare2Pos = "ISDoubleDoor",
					getSquare3Pos = "ISDoubleDoor",
					getSquare4Pos = "ISDoubleDoor",
					partExists = "ISDoubleDoor"
				},
				propertyAdd = {
					sprite = "fixtures_doors_fences_01_",
					spriteIndex = 72,
					sprite2 = "fixtures_doors_fences_01_73",
					sprite3 = "fixtures_doors_fences_01_64",
					sprite4 = "fixtures_doors_fences_01_65",
					northSprite = "fixtures_doors_fences_01_66",
					northSprite2 = "fixtures_doors_fences_01_67",
					northSprite3 = "fixtures_doors_fences_01_74",
					northSprite4 = "fixtures_doors_fences_01_75"
				},
				ingredients = {
					--["Base.MetalPipe"] = 8,
					--["Base.Wire"] = 4
				...
				images = {
					MetalWelding = {
						[0] = {
							...
							west = "fixtures_doors_fences_01_72", north = "fixtures_doors_fences_01_66", east = nil, south = nil,
						}
					}
				},
